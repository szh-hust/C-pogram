...
void put_s_hz(int x, int y, unsigned int string[], int n, FILE *&fp = H_z_00, int color = 0,int x_jj = 2, int y_jj = 4, int w_max = -1, int h_max = -1, unsigned char kong = 0, char juzhong = 0);
